...
import com.example.intro_companion.databinding.FragmentConfirmBinding
...
class ConfirmFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /* Set click listener for going back to form */
        _binding.submitAnotherRequest.setOnClickListener {
            findNavController().navigate(
                ConfirmFragmentDirections.confirmToHome()
            )
        }
    ...
    private fun call() {
        if (requirePermissions()) {
            ...
            intent.data = Uri.parse("tel:$ITS_PHONE")
    ...
    companion object {
        const val PHONE_CALL_REQUEST = 0
        const val ITS_PHONE = "5088315888"
    }
}
